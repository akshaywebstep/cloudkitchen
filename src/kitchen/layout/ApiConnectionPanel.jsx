      ...
      <div className={`grid gap-5 ${compact ? "" : "xl:grid-cols-[1fr_520px] xl:items-center"}`}>
        <div>
          ...
          <div className="mt-5 flex gap-3">
            <button className="rounded-full bg-[#8D0606] px-5 py-2 font-semibold text-white" onClick={() => navigate("/kitchen/branches")} type="button">Add Branch</button>
            <button className="rounded-full bg-[#fff1f1] px-5 py-2 font-semibold text-[#8D0606]" onClick={() => navigate("/kitchen/add-menu")} type="button">Add Menu</button>
          </div>
        </div>
