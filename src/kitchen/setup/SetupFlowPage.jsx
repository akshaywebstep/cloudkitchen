...
function SubscriptionCheckoutWizard({ initialPlan, apiState, onLogout, onComplete }) {
  ...
  const handleAccountSubmit = async (formData) => {
    ...
    try {
      ...
      body.append("contactTitle", (formData.contactTitle || "MR").toUpperCase().replace(/[^A-Z]/g, ""));
  ...
  const handlePaymentVerification = (verificationResult) => {
    if (onComplete) {
      ...
      navigate("/kitchen/login", {
        replace: true,
        state: { justSubscribed: true, email: accountForm.email },
      });
    }
  };
        ...
        <div className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="sm:col-span-2">
              ...
              <div className="relative flex h-11 items-center rounded-xl border border-[#E5DDD9] bg-[#FAF8F6] px-3.5 text-xs shadow-2xs hover:border-[#8D0606]/40 transition group cursor-pointer">
                <input
                  type="file"
                ...
                />
                <span className="truncate text-slate-600 font-medium flex-1">
                  {form.profilePicture?.name ? `🖼️ ${form.profilePicture.name}` : "Upload Brand Logo or Picture (JPG / PNG)"}
                </span>
                <span className="ml-auto shrink-0 flex items-center gap-1.5 rounded-lg bg-[#8D0606] px-3 py-1.5 text-[11px] font-bold text-white shadow-xs group-hover:bg-[#7A0505] transition">
                  <Upload size={13} />
        ...
        <div className="space-y-4 pt-2 border-t border-[#F1EDEB]">
          ...
          <div className="grid gap-4 sm:grid-cols-12">
            ...
            <div className="sm:col-span-3">
              ...
              <select
                value={(form.contactTitle || "MR").toUpperCase().replace(/[^A-Z]/g, "")}
        ...
        <div className="rounded-2xl border border-[#F1E2DB] bg-[#FDFBF9] p-5 space-y-5">
          ...
          <div className="grid gap-5 sm:grid-cols-2">
            ...
            <div>
              ...
              <div className={`relative flex h-11 items-center rounded-xl border bg-[#FAF8F6] px-3.5 text-xs shadow-2xs hover:border-[#8D0606]/40 transition group cursor-pointer ${
...
function KitchenOnboardingWizard({ apiState, onLogout, onComplete }) {
  ...
  const stepsList = [
    ...
    { number: 2, title: "Licenses & Documents", desc: "FSSAI & GSTIN compliance" },
    { number: 3, title: "Review & Dashboard Launch", desc: "Final verification" },
  ];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/65 backdrop-blur-md p-3 sm:p-6 overflow-y-auto">
      ...
      <div className="relative w-full max-w-[760px] my-auto bg-white rounded-2xl sm:rounded-3xl shadow-2xl border border-[#F0E2DB] overflow-hidden flex flex-col max-h-[90vh] animate-in zoom-in-95 duration-200">
        ...
        <div className="overflow-y-auto p-5 sm:p-7 flex-1 space-y-5">
          ...
          {/* STEP 1: Kitchen Profile & Owner Details (PREVIEW UI) */}
          {currentStep === 1 && (
            <div className="space-y-4 animate-in fade-in duration-200">
              <div className="flex items-start justify-between border-b border-[#F1EDEB] pb-3">
                <div>
                ...
                <span className="hidden sm:inline-flex items-center gap-1 rounded-full bg-emerald-50 px-2.5 py-0.5 text-[10.5px] font-bold text-emerald-700 border border-emerald-200">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3.5 rounded-2xl border border-[#F0E2DB] bg-gradient-to-br from-[#FBEEEC]/60 via-white to-white p-4">
                <div className="flex items-center gap-3.5">
                  <div className="grid size-12 shrink-0 place-items-center rounded-2xl bg-gradient-to-br from-[#8D0606] to-[#b80808] text-white shadow-sm ring-4 ring-[#FBEEEC]">
                    <Store size={22} />
                  </div>
                  <div>
                    <h4 className="text-base font-bold text-[#2B1010] flex items-center gap-1.5">
                      {form.kitchenName || "Kitchen Brand"}
                      <BadgeCheck size={16} className="text-[#8D0606]" />
                    </h4>
                    <p className="text-xs font-medium text-[#8A7A76]">
                      {ownerFullName ? `Owned by ${ownerFullName}` : "Registered Cloud Kitchen"}
                    </p>
                  </div>
                </div>

                <div className="flex items-center gap-2">
                  <span className="inline-flex items-center gap-1 rounded-xl bg-[#8D0606]/10 px-3 py-1.5 text-xs font-bold text-[#8D0606] border border-[#8D0606]/20">
                    <Sparkles size={12} />
                    <span>{form.kitchenType || "Cloud Kitchen"}</span>
                  </span>
                </div>
              </div>

              {/* Info Preview Cards Grid */}
              <div className="grid gap-3 sm:grid-cols-2">
                {/* Kitchen / Brand Name */}
                <div className="rounded-2xl border border-[#EDE4E0] bg-[#FAF8F6]/70 p-3.5 transition-all hover:bg-white hover:shadow-xs">
                  <div className="flex items-center gap-2 text-[#8A7A76] mb-1.5">
                    <span className="grid size-6 place-items-center rounded-lg bg-white text-[#8D0606] shadow-2xs border border-[#EDE4E0]">
                      <Store size={13} />
                    </span>
                    <span className="text-[11px] font-bold uppercase tracking-wider">Kitchen / Brand Name</span>
                  </div>
                  <p className="text-xs sm:text-sm font-bold text-[#2B1010] pl-8">
                    {form.kitchenName || "Not Provided"}
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-[#EDE4E0] bg-[#FAF8F6]/70 p-3.5 transition-all hover:bg-white hover:shadow-xs">
                  <div className="flex items-center gap-2 text-[#8A7A76] mb-1.5">
                    <span className="grid size-6 place-items-center rounded-lg bg-white text-[#C2410C] shadow-2xs border border-[#EDE4E0]">
                      <Building2 size={13} />
                    </span>
                    <span className="text-[11px] font-bold uppercase tracking-wider">Category Model</span>
                  </div>
                  <p className="text-xs sm:text-sm font-bold text-[#2B1010] pl-8">
                    {form.kitchenType || "Cloud Kitchen"}
                  </p>
                </div>
                ...
                <div className="rounded-2xl border border-[#EDE4E0] bg-[#FAF8F6]/70 p-3.5 transition-all hover:bg-white hover:shadow-xs">
                  <div className="flex items-center gap-2 text-[#8A7A76] mb-1.5">
                    <span className="grid size-6 place-items-center rounded-lg bg-white text-[#15803D] shadow-2xs border border-[#EDE4E0]">
                      <User size={13} />
                    </span>
                    <span className="text-[11px] font-bold uppercase tracking-wider">Owner / Contact Person</span>
                  </div>
                  <p className="text-xs sm:text-sm font-bold text-[#2B1010] pl-8">
                ...
                <div className="rounded-2xl border border-[#EDE4E0] bg-[#FAF8F6]/70 p-3.5 transition-all hover:bg-white hover:shadow-xs">
                  <div className="flex items-center gap-2 text-[#8A7A76] mb-1.5">
                    <span className="grid size-6 place-items-center rounded-lg bg-white text-[#1D4ED8] shadow-2xs border border-[#EDE4E0]">
                      <Phone size={13} />
                    </span>
                    <span className="text-[11px] font-bold uppercase tracking-wider">Registered Phone</span>
                  </div>
                  <p className="text-xs sm:text-sm font-bold text-[#2B1010] font-mono pl-8">
                    {form.kitchenPhone ? `+91 ${form.kitchenPhone}` : "Not Provided"}
                  </p>
                </div>

                {/* Registered Email */}
                <div className="sm:col-span-2 rounded-2xl border border-[#EDE4E0] bg-[#FAF8F6]/70 p-3.5 transition-all hover:bg-white hover:shadow-xs">
                  <div className="flex items-center gap-2 text-[#8A7A76] mb-1.5">
                    <span className="grid size-6 place-items-center rounded-lg bg-white text-[#7E22CE] shadow-2xs border border-[#EDE4E0]">
                      <Mail size={13} />
                    </span>
                    <span className="text-[11px] font-bold uppercase tracking-wider">Registered Account Email</span>
                  </div>
                  <p className="text-xs sm:text-sm font-bold text-[#2B1010] pl-8 break-all">
                    {form.kitchenEmail || "Not Provided"}
                  </p>
                </div>
              </div>
            </div>
          ...
          {/* STEP 2: Licenses & Documents */}
          {currentStep === 2 && (
            <div className="space-y-4 animate-in fade-in duration-200">
              <div className="border-b border-[#F1EDEB] pb-3">
                <h3 className="text-sm font-bold text-[#2B1010]">2. Government Licenses & Uploaded Documents</h3>
          ...
          {currentStep === 3 && (
            <div className="space-y-4 animate-in fade-in duration-200">
              <div className="border-b border-[#F1EDEB] pb-3">
                <h3 className="text-sm font-bold text-[#2B1010]">3. Review Setup & Launch Operations Dashboard</h3>
        ...
        <div className="flex items-center justify-between border-t border-[#F1EDEB] bg-[#FCFBFA] px-5 py-3.5 sm:px-6">
          {currentStep > 1 ? (
            <button
              ...
              onClick={handleBack}
              disabled={saving}
              className="flex items-center gap-1.5 rounded-xl border border-[#E5DDD9] bg-white px-4 py-2.5 text-xs font-bold text-[#5B4A45] hover:bg-[#FAF8F6] disabled:opacity-60 transition"
            >
              <ChevronLeft size={16} />
          ...
          {currentStep < 3 ? (
            <button
              type="button"
              onClick={handleNext}
              className="flex items-center gap-2 rounded-xl bg-[#8D0606] px-6 py-2.5 text-xs font-bold text-white shadow-md shadow-[#8D0606]/20 hover:bg-[#7A0505] active:scale-95 transition"
            >
              <span>Next Step</span>
              <ChevronRight size={16} />
            </button>
            ...
            <button
              ...
              disabled={saving}
              className="flex items-center gap-2 rounded-xl bg-gradient-to-r from-[#8D0606] to-[#b80808] px-6 py-2.5 text-xs sm:text-sm font-black text-white shadow-lg shadow-[#8D0606]/25 hover:from-[#7A0505] hover:to-[#a30707] active:scale-95 disabled:opacity-60 transition"
            >
              {saving ? (
                <>
                  <Loader2 size={16} className="animate-spin" />
