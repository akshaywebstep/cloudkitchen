...
import { X, Bell, MessageSquareText, Gift, ChevronRight } from "lucide-react";
      ...
      <div className="space-y-1.5 my-2">
        {items.map((item, index) => (
          <button
            ...
            onClick={() => onAction(index === 0 ? "Order List" : index === 1 ? "Category" : "Dashboard")}
            type="button"
          >
