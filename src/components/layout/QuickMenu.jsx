...
const QUICK_LINKS = [
  { label: "Dashboard",         path: "/",           module: "dashboard", action: "VIEW" },
  { label: "Order List",        path: "/orders",     module: "order",     action: "VIEW" },
  { label: "Food Menu",         path: "/menu",       module: "menu",      action: "VIEW" },
  { label: "Add Menu",          path: "/add-menu",   module: "menu",      action: "CREATE" },
  { label: "Customer List",     path: "/customers",  module: "customer",  action: "VIEW" },
  { label: "Customer Review",   path: "/reviews",    module: "reviews",   action: "VIEW" },
  { label: "Add / Edit Kitchen", path: "/kitchen",   module: "branch",    action: "VIEW" },
];
